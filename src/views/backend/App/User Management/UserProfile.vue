                        ...
                        <div class="card-body">
                           <ul class="list-inline p-0 mb-0">
                              ...
                              <div class="col-lg-4 align-items-center">
                                 <p class="mb-0 text-dark font-size-16 align-items-center mr-0">English</p>
                              </div>
                              <div class="col-lg-6 iq-progress-bar-linear align-items-center d-inline-block iq-progress-height w-100">
                                   <Progressbar :value="70" color="primary" />
                                 
                              </div>
                              <div class="col-2">
                                       <div class="percentage float-right  text-primary font-weight-bold">70%
                              </div>
                              </div>
                           </div>
                              </li>
                              <li>
                                 <div class="d-flex align-items-center justify-content-between row mt-3">
                              <div class="col-lg-4">
                                 <p class="mb-0 text-dark font-size-16 mr-0">Spanish</p>
                              </div>
                              <div class="col-lg-6 iq-progress-bar-linear d-inline-block iq-progress-height w-100">
                                   <Progressbar :value="50" color="success"/>
                                 
                              </div>
                              <div class="col-2">
                                       <div class="percentage float-right  text-success font-weight-bold">50%
                              </div>
                              </div>
                           </div>
                              </li>
                              <li>
                                 <div class="d-flex align-items-center justify-content-between row mt-3">
                              <div class="col-lg-4">
                                 <p class="mb-0 text-dark font-size-16 mr-0">French</p>
                              </div>
                              <div class="col-lg-6 iq-progress-bar-linear d-inline-block iq-progress-height w-100">
                              ...
                              <div class="col-2">
                                       <div class="percentage float-right  text-info font-weight-bold">65%
                              </div>
                              </div>
                           </div>
                              </li>
                     ...
                     <ul class="list-inline p-0 mb-0">
                        <li>
                           <div class="d-flex align-items-center justify-content-between mb-4 row">
                              ...
                              <div class="col-lg-8">
                                  <Progressbar :value="85" color="primary" colorName="primary" class="progress-1 mt-2">
                        ...
                        <li>
                           <div class="d-flex align-items-center justify-content-between mb-4 row">
                              ...
                              <div class="col-lg-8">
                                   <Progressbar :value="65" color="warning" colorName="warning" class="   progress-1 mt-2">
                              <template v-slot:text>
                        ...
                        <li>
                           <div class="d-flex align-items-center justify-content-between mb-4 row">
                              ...
                              <div class="col-lg-8">
                                     <Progressbar :value="55" color="success" colorName="success" class="   progress-1 mt-2">
                              <template v-slot:text>
                        ...
                        <li>
                           <div class="d-flex align-items-center justify-content-between row">
                              ...
                              <div class="col-lg-8">
                                   <Progressbar :value="60" color="info" colorName="info" class="   progress-1 mt-2">
                              <template v-slot:text>
