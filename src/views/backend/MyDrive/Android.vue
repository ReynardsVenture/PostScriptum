                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Strategy.docx"  :data-url="`${baseUrl}/doc-viewer/files/demo.docx`" @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal ><img src="@/assets/images/layouts/page-2/doc.png" class="img-fluid" alt="image1"></a>
                                </div>
                                <h6>Strategy.docx</h6>     
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Web.xlsx"  :data-url="`${baseUrl}/doc-viewer/files/demo.xlsx`" @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-2/xlsx.png" class="img-fluid" alt="image1"></a>
                                </div>
                                <h6>Web.xlsx</h6> 
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Testing.pptx"  :data-url="`${baseUrl}/doc-viewer/files/demo.pptx`" @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-2/ppt.png" class="img-fluid" alt="image1"></a>           
                                </div>
                                <h6>Testing.pptx</h6>          
                            </div>
                        </div>
    ...
    data(){
        return{
            datas:[
                {
                    name:'Demo.pdf',
                    src:require('@/assets/images/layouts/page-2/01.png')
                },
                {
                    name:'B2P.png',
                    src:require('@/assets/images/layouts/page-2/02.png')
                },
                {
                    name:'Blog.svg',
                    src:require('@/assets/images/layouts/page-2/03.png')
                },
                {
                    name:'Devloper.mp3',
                    src:require('@/assets/images/layouts/page-2/04.png')
                }
            ],
            data:true,
            lists:[
                {
                     img:true,
                    name:'Alexa.jpeg',
                    image:require('@/assets/images/layouts/page-2/01.png'),
                    owner:'me',
                    size:'02 MB',
                ...
                },
                 {
                      img:true,
                    name:'Alexa2.png',
                    image:require('@/assets/images/layouts/page-2/02.png'),
                    owner:'Poul Molive',
                    size:'64 MB',
                ...
                },
                 {
                      img:true,
                    name:'Alexa3.svg',
                    image:require('@/assets/images/layouts/page-2/03.png'),
                    owner:'me',
                    size:'30 MB',
                ...
                },
                 {
                      img:true,
                    name:'Alexa4.eps',
                    image:require('@/assets/images/layouts/page-2/04.png'),
                    owner:'me',
                    size:'10 MB',
                    lastedit:'Mar 30, 2020 Gail Forcewind'
                },
                 {
                    ...
                    name:'Alexa5.pdf',
                    image:require('@/assets/images/layouts/page-2/pdf.png'),
                    owner:'me',
                    size:'10 MB',
                    lastedit:'Mar 30, 2020 Gail Forcewind'
                },
                 {
                    ...
                    name:'Alexa6.docx',
                    image:require('@/assets/images/layouts/page-2/doc.png'),
                    owner:'Penny',
                    size:'65 MB',
                ...
                },
                 {
                    ...
                    name:'Alexa8.xlsx',
                    image:require('@/assets/images/layouts/page-2/xlsx.png'),
                    owner:'Banny',
                    size:'90 MB',
                ...
                },
                 {
                    ...
                    name:'Alexa7.pptx',
                    image:require('@/assets/images/layouts/page-2/ppt.png'),
                    owner:'me',
                    size:'10 MB',
