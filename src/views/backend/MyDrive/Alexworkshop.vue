                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    ...
                                    <a href="#"  :data-url="`${baseUrl}/doc-viewer/files/demo.pdf`"  data-title="Mobile-plan.pdf"  @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-1/pdf.png" class="img-fluid" alt="image1"></a>         
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Strategy.docx" :data-url="`${baseUrl}/doc-viewer/files/demo.docx`"  @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-1/doc.png" class="img-fluid" alt="image1"></a>
                                </div>
                                <h6>Strategy.docx</h6>     
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Web.xlsx" :data-url="`${baseUrl}/doc-viewer/files/demo.xlsx`"  @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-1/xlsx.png" class="img-fluid" alt="image1"></a>
                                </div>
                                <h6>Web.xlsx</h6> 
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Testing.pptx" :data-url="`${baseUrl}/doc-viewer/files/demo.pptx`"  @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-1/ppt.png" class="img-fluid" alt="image1"></a>           
                                </div>
                                <h6>Testing.pptx</h6>          
                            </div>
                        </div>
    ...
    data(){
        return{
            datas:[
                {
                    name:'Alexa.jpeg',
                    src:require('@/assets/images/layouts/page-1/01.png')
                },
                {
                    name:'Eliminator.png',
                    src:require('@/assets/images/layouts/page-1/02.png')
                },
                {
                    name:'Screenshot.svg',
                    src:require('@/assets/images/layouts/page-1/03.png')
                },
                {
                    name:'Video.mp4',
                    src:require('@/assets/images/layouts/page-1/04.png')
                }
            ],
            data:true,
            lists:[
                {
                    img:true,
                    name:'Alexa.jpeg',
                    image:require('@/assets/images/layouts/page-1/01.png'),
                    owner:'me',
                    size:'02 MB',
                ...
                },
                 {
                     img:true,
                    name:'Alexa2.png',
                    image:require('@/assets/images/layouts/page-1/02.png'),
                    owner:'Poul Molive',
                    size:'64 MB',
                ...
                },
                 {
                     img:true,
                    name:'Alexa3.svg',
                    image:require('@/assets/images/layouts/page-1/03.png'),
                    owner:'me',
                    size:'30 MB',
                ...
                },
                 {
                     img:true,
                    name:'Alexa4.eps',
                    image:require('@/assets/images/layouts/page-1/04.png'),
                    owner:'me',
                    size:'10 MB',
                    lastedit:'Mar 30, 2020 Gail Forcewind'
                },
