                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    ...
                                    <a href="#" data-title="Spike.pdf" :data-url="`${baseUrl}/doc-viewer/files/demo.pdf`" @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-7/pdf.png" class="img-fluid" alt="image1"></a>         
                                </div>
                                <h6>Spike.pdf</h6>            
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Support.docx" :data-url="`${baseUrl}/doc-viewer/files/demo.docx`" @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-7/doc.png" class="img-fluid" alt="image1"></a>
                                </div>
                                <h6>Support.docx</h6>     
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Colour.xlsx" :data-url="`${baseUrl}/doc-viewer/files/demo.xlsx`" @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-7/xlsx.png" class="img-fluid" alt="image1"></a>
                                </div>
                                <h6>Colour.xlsx</h6> 
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-block card-stretch card-height">
                            <div class="card-body image-thumb">
                                <div class="mb-4 text-center p-3 rounded iq-thumb">
                                    <div class="iq-image-overlay"></div>
                                    <a href="#" data-title="Flavour.pptx" :data-url="`${baseUrl}/doc-viewer/files/demo.pptx`" @click="$root.$emit('bv::show::modal', 'viewer-modal', $event.target)" v-b-modal.viewer-modal><img src="@/assets/images/layouts/page-7/ppt.png" class="img-fluid" alt="image1"></a>           
                                </div>
                                <h6>Flavour.pptx</h6>          
                            </div>
                        </div>
